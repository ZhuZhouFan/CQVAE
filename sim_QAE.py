...
def train_once(repetition_index, bandwidth, N, T, P_f, P_x, P_c, W, linear_index, K, lr, f_hidden_dim, lam, tau, AE_epoch_num, AE_factor_epoch_num, root_log_dir, seed):
...
def run(args):
    ...
    for repetition_index in range(repetition_num):
        R_total, R_pred = train_once(repetition_index, bandwidth, N, T, P_f, P_x, P_c, W, linear_index, K, lr, f_hidden_dim, lam, tau, AE_epoch_num, AE_factor_epoch_num, root_log_dir, seed)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_name', type=str, default = 'QAE_test')
